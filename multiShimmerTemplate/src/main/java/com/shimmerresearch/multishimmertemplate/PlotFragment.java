...
//                            textView.setText(final_location);
							...
							String time_formatted = sdf.format(new Date(location.getTime()));
							Log.d("Lat+Lon---", "here1 "+final_location+" Time: "+time_formatted);
...
//		            		 	    		Log.d("ShimmerPLOT",mBluetoothAddressforPlot[i] + " : " + mSensorsforPlot[i][k]);
	            		 	    			...
	            		 	    			Log.d("Shimmer","Data : " +deviceNames[i] + formatCluster.mData + " "+ formatCluster.mUnits);
